  ...
  <div class="col-9">
    ...
    <h3 id="list-item-1"><b>Wikidata Atlas<i class="bi bi-globe-americas mx-2"></i></b></h3>
      <p>Wikidata Atlas is a platform that allows Wikidata entities that have geographic coordinate properties to be displayed on a world map.</p>
        ...
        <p>In the following example you can see the results of searching for entities that are <b>stadium</b> instances:</p>
	<p>To use the system, the first thing you must do is search in the search bar available on the <b>Home</b> page. Automatically while you are typing, the search bar will suggest some item labels for auto-completion. You <b>must select</b> the option you want, in our case we will select <b>stadium (Q483110)</b>. What is in brackets corresponds to the <a href="https://www.wikidata.org/wiki/Wikidata:Identifiers" target="_blank" rel="noopener noreferrer">unique identifier</a> of the entity. In the following image you can see some of the options that appear while you type the entity label.</p>
	<p><img src="demo\img\search_bar.png" alt="search_bar" class="img-fluid p-2 border mx-auto d-block"/></p>
	<p>You can see that to the right of the search bar there is an option selector to specify a <b>limit</b> of entities that you want to retrieve, this can be 10, 100, 1000, 10000, 100000 or No limit (default option). This selector is highly recommended to use when you want to search for types that have many instances such as mountains, rivers, architectural ensembles, among others; since depending on the number of instances that the type has, the generation of the markers or clusters in the map can take time. Then you can press the search button.</p>
	<p>Below you can see the system interface after the generation of markers and clusters in the map.</p>
        ...
        <p>In the following image you can see the visualization of the entities on the map after applying zoom and click one specific marker.</p>
        <p><img src="demo\img\zoom.png" alt="zoom" class='img-fluid p-2 border'/></p>
        <p>Following are some of the most important concepts and tools used to develop Wikidata Atlas.</p>
